...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <h1 style="color: teal;text-align:center;">ARM Robot</h1>
    <h2 style="color: teal;text-align:center;">Control Panel</h2>
    ...
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=10>
      ...
      <tr/><tr/>
      <!--  Added new Wrist servo slider -->
      <tr>
        <td style="text-align:left;font-size:25px"><b>Wrist:</b></td>
        <td colspan=2>
         <div class="slidecontainer">
            <input type="range" min="0" max="180" value="90" class="slider" id="Wrist" oninput='sendButtonInput("Wrist",value)'>
          </div>
        </td>
      </tr> 
      <tr/><tr/> 
    ...
    case WS_EVT_DATA:
      {
        ...
        if (info->final && info->index == 0 && info->len == len && info->opcode == WS_TEXT) {
          ...
          else if (key == "Base") writeServoValues(0, valueInt);            
          else if (key == "Shoulder") writeServoValues(1, valueInt);           
          else if (key == "Elbow") writeServoValues(2, valueInt);           
          else if (key == "Gripper") writeServoValues(3, valueInt);     
          else if (key == "Wrist") writeServoValues(4, valueInt); 
        }
      }
      break;
    default:
